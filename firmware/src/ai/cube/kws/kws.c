...
#define AI_KWS_MODEL_SIGNATURE     "eaa238a54d93da4afb68ed83e3cd5adb"
...
#define AI_TOOLS_DATE_TIME   "Sun May 17 09:49:55 2020"
...
AI_STATIC ai_array conv2d_4_bias_array;   /* Array #4 */
AI_STATIC ai_array conv2d_4_weights_array;   /* Array #5 */
...
AI_STATIC ai_array conv2d_4_output_array;   /* Array #16 */
AI_STATIC ai_array dense_1_output_array;   /* Array #17 */
AI_STATIC ai_array softmax_1_output_array;   /* Array #18 */
...
AI_STATIC ai_tensor conv2d_4_bias;   /* Tensor #4 */
AI_STATIC ai_tensor conv2d_4_weights;   /* Tensor #5 */
...
AI_STATIC ai_tensor conv2d_4_output;   /* Tensor #16 */
AI_STATIC ai_tensor conv2d_4_output0;   /* Tensor #17 */
AI_STATIC ai_tensor dense_1_output;   /* Tensor #18 */
AI_STATIC ai_tensor softmax_1_output;   /* Tensor #19 */
...
AI_STATIC_CONST ai_tensor_chain softmax_1_chain;   /* Chain #5 */
...
AI_STATIC ai_layer_nl softmax_1_layer; /* Layer #5 */
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0, AI_SHAPE_INIT(4, 1, 32, 7, 2), AI_STRIDE_INIT(4, 4, 4, 128, 896),
  1, &conv2d_2_scratch0_array, NULL)
AI_TENSOR_OBJ_DECLARE(
  conv2d_1_scratch0, AI_STATIC,
  0x0, 0x0, AI_SHAPE_INIT(4, 1, 16, 9, 2), AI_STRIDE_INIT(4, 4, 4, 64, 576),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0, AI_SHAPE_INIT(4, 96, 10, 1, 1), AI_STRIDE_INIT(4, 4, 384, 3840, 3840),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0, AI_SHAPE_INIT(4, 64, 3, 3, 32), AI_STRIDE_INIT(4, 4, 256, 768, 2304),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0, AI_SHAPE_INIT(4, 1, 5, 5, 16), AI_STRIDE_INIT(4, 4, 4, 20, 100),
  1, &conv2d_1_weights_array, NULL)
AI_TENSOR_OBJ_DECLARE(
  input_1_output, AI_STATIC,
  0x0, 0x0, AI_SHAPE_INIT(4, 1, 1, 13, 31), AI_STRIDE_INIT(4, 4, 4, 4, 52),
  1, &input_1_output_array, NULL)
AI_TENSOR_OBJ_DECLARE(
  conv2d_1_output, AI_STATIC,
  0x0, 0x0, AI_SHAPE_INIT(4, 1, 16, 9, 13), AI_STRIDE_INIT(4, 4, 4, 64, 576),
  1, &conv2d_1_output_array, NULL)
AI_TENSOR_OBJ_DECLARE(
  conv2d_2_output, AI_STATIC,
  0x0, 0x0, AI_SHAPE_INIT(4, 1, 32, 7, 5), AI_STRIDE_INIT(4, 4, 4, 128, 896),
  1, &conv2d_2_output_array, NULL)
AI_TENSOR_OBJ_DECLARE(
  conv2d_3_output, AI_STATIC,
  0x0, 0x0, AI_SHAPE_INIT(4, 1, 64, 5, 3), AI_STRIDE_INIT(4, 4, 4, 256, 1280),
  1, &conv2d_3_output_array, NULL)
AI_TENSOR_OBJ_DECLARE(
  conv2d_4_output, AI_STATIC,
  0x0, 0x0, AI_SHAPE_INIT(4, 1, 32, 3, 1), AI_STRIDE_INIT(4, 4, 4, 128, 384),
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_ENTRY(&dense_1_output),
  AI_TENSOR_LIST_ENTRY(&softmax_1_output),
  AI_TENSOR_LIST_EMPTY,
  AI_TENSOR_LIST_EMPTY
)
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_U8,
                     1, 1, 10304, 1,
                     NULL),
  AI_TENSOR_LIST_IO_ENTRY(AI_FLAG_NONE, AI_KWS_IN_NUM, &input_1_output),
  AI_TENSOR_LIST_IO_ENTRY(AI_FLAG_NONE, AI_KWS_OUT_NUM, &softmax_1_output),
  ...
  ai_network* net_ctx, const ai_buffer* activation_buffer)
{
...

  {
    ...
    conv2d_2_scratch0_array.data = AI_PTR(activations + 8512);
    conv2d_2_scratch0_array.data_start = AI_PTR(activations + 8512);
    conv2d_1_scratch0_array.data = AI_PTR(activations + 8512);
    conv2d_1_scratch0_array.data_start = AI_PTR(activations + 8512);
    input_1_output_array.data = AI_PTR(NULL);
    input_1_output_array.data_start = AI_PTR(NULL);
    conv2d_1_output_array.data = AI_PTR(activations + 1024);
    conv2d_1_output_array.data_start = AI_PTR(activations + 1024);
    conv2d_2_output_array.data = AI_PTR(activations + 0);
    conv2d_2_output_array.data_start = AI_PTR(activations + 0);
    conv2d_3_output_array.data = AI_PTR(activations + 4672);
    conv2d_3_output_array.data_start = AI_PTR(activations + 4672);
    conv2d_4_output_array.data = AI_PTR(activations + 4288);
    conv2d_4_output_array.data_start = AI_PTR(activations + 4288);
    dense_1_output_array.data = AI_PTR(activations + 4248);
    dense_1_output_array.data_start = AI_PTR(activations + 4248);
  ...
  ai_network* net_ctx, const ai_buffer* weights_buffer)
{
...

  {
    ...
    dense_1_bias_array.data = AI_PTR(weights + 171904);
    dense_1_bias_array.data_start = AI_PTR(weights + 171904);
    dense_1_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_1_weights_array.data = AI_PTR(weights + 168064);
    dense_1_weights_array.data_start = AI_PTR(weights + 168064);
    conv2d_4_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_4_bias_array.data = AI_PTR(weights + 167936);
    conv2d_4_bias_array.data_start = AI_PTR(weights + 167936);
    conv2d_4_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_4_weights_array.data = AI_PTR(weights + 94208);
    conv2d_4_weights_array.data_start = AI_PTR(weights + 94208);
    conv2d_3_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_3_bias_array.data = AI_PTR(weights + 93952);
    conv2d_3_bias_array.data_start = AI_PTR(weights + 93952);
    conv2d_3_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_3_weights_array.data = AI_PTR(weights + 20224);
    conv2d_3_weights_array.data_start = AI_PTR(weights + 20224);
    conv2d_2_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_2_bias_array.data = AI_PTR(weights + 20096);
    conv2d_2_bias_array.data_start = AI_PTR(weights + 20096);
    conv2d_2_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_2_weights_array.data = AI_PTR(weights + 1664);
    conv2d_2_weights_array.data_start = AI_PTR(weights + 1664);
    conv2d_1_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_1_bias_array.data = AI_PTR(weights + 1600);
    conv2d_1_bias_array.data_start = AI_PTR(weights + 1600);
  ...
  ai_handle network, const ai_network_params* params)
{
  ...
  ai_bool ok = true;
  ok &= kws_configure_weights(net_ctx, &params->params);
  ok &= kws_configure_activations(net_ctx, &params->activations);
