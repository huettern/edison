...
#define AI_KWS_MODEL_SIGNATURE     "f2e4d25f787b198cdfe9b8eeb69704ef"
...
#define AI_TOOLS_DATE_TIME   "Fri May  8 13:44:58 2020"
...
AI_STATIC ai_array conv2d_bias_array;   /* Array #3 */
AI_STATIC ai_array conv2d_weights_array;   /* Array #4 */
AI_STATIC ai_array input_0_output_array;   /* Array #5 */
AI_STATIC ai_array conv2d_output_array;   /* Array #6 */
AI_STATIC ai_array dense_output_array;   /* Array #7 */
AI_STATIC ai_array softmax_output_array;   /* Array #8 */
...
AI_STATIC ai_tensor conv2d_bias;   /* Tensor #3 */
AI_STATIC ai_tensor conv2d_weights;   /* Tensor #4 */
AI_STATIC ai_tensor input_0_output;   /* Tensor #5 */
AI_STATIC ai_tensor conv2d_output;   /* Tensor #6 */
AI_STATIC ai_tensor conv2d_output0;   /* Tensor #7 */
AI_STATIC ai_tensor dense_output;   /* Tensor #8 */
AI_STATIC ai_tensor softmax_output;   /* Tensor #9 */


/**  Forward network tensor chain declarations  *******************************/
AI_STATIC_CONST ai_tensor_chain conv2d_chain;   /* Chain #0 */
AI_STATIC_CONST ai_tensor_chain dense_chain;   /* Chain #1 */
AI_STATIC_CONST ai_tensor_chain softmax_chain;   /* Chain #2 */


/**  Forward network layer declarations  **************************************/
AI_STATIC ai_layer_conv2d_nl_pool conv2d_layer; /* Layer #0 */
AI_STATIC ai_layer_dense dense_layer; /* Layer #1 */
AI_STATIC ai_layer_nl softmax_layer; /* Layer #2 */
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0, AI_SHAPE_INIT(4, 1, 8, 13, 2), AI_STRIDE_INIT(4, 4, 4, 32, 416),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0, AI_SHAPE_INIT(4, 720, 5, 1, 1), AI_STRIDE_INIT(4, 4, 2880, 14400, 14400),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0, AI_SHAPE_INIT(4, 1, 8, 8, 8), AI_STRIDE_INIT(4, 4, 4, 32, 256),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0, AI_SHAPE_INIT(4, 1, 8, 6, 15), AI_STRIDE_INIT(4, 4, 4, 32, 192),
  1, &conv2d_output_array, NULL)
AI_TENSOR_OBJ_DECLARE(
  conv2d_output0, AI_STATIC,
  0x0, 0x0, AI_SHAPE_INIT(4, 1, 720, 1, 1), AI_STRIDE_INIT(4, 4, 4, 2880, 2880),
  1, &conv2d_output_array, NULL)
AI_TENSOR_OBJ_DECLARE(
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_ENTRY(&conv2d_output0),
  ...
  ai_network* net_ctx, const ai_buffer* activation_buffer)
{
...

  {
    ...
    conv2d_output_array.data = AI_PTR(activations + 832);
    conv2d_output_array.data_start = AI_PTR(activations + 832);
  ...
  ai_network* net_ctx, const ai_buffer* weights_buffer)
{
...

  {
    ...
    dense_bias_array.data = AI_PTR(weights + 16480);
    dense_bias_array.data_start = AI_PTR(weights + 16480);
    dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_weights_array.data = AI_PTR(weights + 2080);
    dense_weights_array.data_start = AI_PTR(weights + 2080);
    conv2d_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_bias_array.data = AI_PTR(weights + 2048);
    conv2d_bias_array.data_start = AI_PTR(weights + 2048);
